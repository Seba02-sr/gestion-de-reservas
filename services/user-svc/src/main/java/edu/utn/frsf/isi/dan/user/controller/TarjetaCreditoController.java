...
public class TarjetaCreditoController {
  ...
  @Operation(
      summary = "Obtejer una tarjeta de credito por ID",
      description = "Devuelve una tarejta de credito por su ID",
      tags = {"Tarjetas"})
  @ApiResponses(
      value = {
  ...
  @Operation(
      summary = "Obtener todas las tarjetas de un huesped",
      description = "Devuelve una lista de todas las tarjetas de credito asociadas a un huesped",
      tags = {"Tarjetas"})
  @ApiResponses(
      value = {
  ...
  @Operation(
      ...
      description = "Elimina una tarjeta de credito, no principal, del sistema por su ID",
      tags = {"Tarjetas"})
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "409",
            description = "No se puede eliminar la tarjeta principal"),
        @ApiResponse(responseCode = "500", description = "Error interno del servidor")
      })
  // DELETE /tarejtas/{id}
  @DeleteMapping("/{id}")
  ...
  @Operation(
      summary = "Marcar una tarjeta como principal",
      description = "Marca una tarjeta como la principal del huesped y desactiva otras",
      tags = {"Tarjetas"})
  @ApiResponses(
      value = {
