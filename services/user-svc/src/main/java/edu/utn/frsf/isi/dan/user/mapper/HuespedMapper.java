...
public interface HuespedMapper {
  ...
  /**
   * Convierte HuespedRequest a Huesped Entity El ID se setea como null automaticamente para nuevas
   * entidades
   *
   * @param request
   * @return
  ...
  /**
   * Actualiza untidad existente con datos del request. Utilizado para operaciones de UPDATE
   *
   * @param request
   * @param huesped
   */
  ...
  void updateEntityFromRequest(
      HuespedRequest request, @org.mapstruct.MappingTarget Huesped huesped);
}
