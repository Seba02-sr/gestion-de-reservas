...
public class TarjetaCreditoService {
    ...
    @Autowired
    public TarjetaCreditoMapper tarjetaCreditoMapper;
    ...
    // public TarjetaCreditoResponse crearTarhetaParaHuesped(Long huespedId, TarjetaCreditoRequest tarjetaCreditoRequest){
    //     if (tarjetaCreditoRequest == null){
    //         throw new IllegalArgumentException("La tarjeta no puede ser nula");
    //     }
    ...
    public TarjetaCreditoResponse updateTarjetaCredito(Long id, TarjetaCreditoRequest tarjetaCreditoRequest) {
        ...
        TarjetaCredito tarjetaCreditoActualizada = tarjetaCreditoRepository.save(tarjetaCreditoExistente);
    ...
    public TarjetaCreditoResponse setTarjetaPrincipal(Long id){
        ...
        List<TarjetaCredito> otrasTarjetas = tarjetaCreditoRepository.findByHuespedIdAndIdNot(tarjetaCredito.getHuesped().getId(), id);
