...
public class PropietarioMapperTest {
    ...
    void toEntity_DeberiaRetornarEntidad_CuandoRequestEsValido() {
        PropietarioRequest request = PropietarioRequest.builder()
        ...
        assertAll("Verificaciones de Propietario",
    ...
    void toResponse_DeberiaRetornarDTO_CuandoEntidadEsValida() {
        Propietario propietario = Propietario.builder()
                ...
                .dni("12345678")
                .username("propietario")
                .cuentaBancaria(CuentaBancaria.builder().id(1).numeroCuenta("123456789")
                        .banco(Banco.builder().id(1).nombre("Banco Test").build()).build())
                .build();
        PropietarioResponse result = propietarioMapper.toResponse(propietario);
        assertAll("Verificaciones de PropietarioResponse",
    ...
    void updateEntityFromRequest_DeberiaActualizarCampos_CuandoRequestEsValido() {
        Propietario propietario = Propietario.builder()
                ...
                .username("propietario")
                .cuentaBancaria(CuentaBancaria.builder().id(1).numeroCuenta("123456789")
                        .banco(Banco.builder().id(1).nombre("Banco Viejo").build()).build())
                .build();
        PropietarioRequest request = PropietarioRequest.builder()
        ...
        assertAll("Verificaciones de actualización de Propietario",
                () -> assertNotNull(propietario),
