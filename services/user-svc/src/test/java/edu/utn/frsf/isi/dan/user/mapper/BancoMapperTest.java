...
public class BancoMapperTest {
  ...
  void toEntity_DeberiaRetornarEntidad_CuandoRequestEsValido() {
    BancoRequest request = BancoRequest.builder().nombre("Banco Test").build();
  ...
  void updateEntityFromRequest_DeberiaActualizarCampos_CuandoRequestEsValido() {
    Banco banco = Banco.builder().id(1).nombre("Banco Viejo").activo(true).build();

    BancoRequest request = BancoRequest.builder().nombre("Banco Nuevo").build();
