...
public class HuespedMapperTest {
    ...
    void toEntity_DeberiaRetornarEntidad_CuandoRequestEsValido() {
        HuespedRequest request = HuespedRequest.builder()
                .nombre("Juan")
                ...
                .tarjetasCredito(List.of(TarjetaCreditoRequest.builder().numero("1234567890123456").build()))
                .build();
        Huesped huesped = huespedMapper.toEntity(request);

        assertAll("Verificaciones de Huesped",
    ...
    void toResponse_DeberiaRetornarDTO_CuandoEntidadEsValida() {
        ...
        assertAll("Verificaciones de HuespedResponse",
    ...
    void updateEntityFromRequest_DeberiaActualizarCampos_CuandoRequestEsValido() {
        ...
        HuespedRequest request = HuespedRequest.builder()
                ...
                .tarjetasCredito(List.of(TarjetaCreditoRequest.builder().numero("6543210987654321").build()))
                .build();

        huespedMapper.updateEntityFromRequest(request, huesped);
        assertAll("Verificaciones de actualización de Huesped",
                () -> assertNotNull(huesped),
