...
public interface AmenityHotelMapper {
    ...
    /**
     * Convierte AmenityHotelRequest a AmenityHotel Entity
     * El ID se setea como null automáticamente para nuevas entidades
     * 
     * @param request
     * @return
     */
    ...
    void updateEntityFromRequest(AmenityHotelRequest request, @MappingTarget AmenityHotel amenityHotel);
}
