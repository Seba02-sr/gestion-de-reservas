...
public class HotelController {
  ...
  @Operation(
      ...
      description =
          "Permite actualizar la categoría, el teléfono y el correo de contacto de un hotel existente.",
      responses = {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<HotelResponse> actualizarHotel(
      @PathVariable Integer id, @Valid @RequestBody HotelRequest hotelRequest) {
    return new ResponseEntity<>(hotelService.actualizarHotel(id, hotelRequest), HttpStatus.OK);
  }

  @Operation(
      summary = "Agregar amenities a un hotel",
  ...
  public ResponseEntity<HotelResponse> agregarAmenities(
      @PathVariable Integer id, @RequestBody List<AmenityHotelRequest> amenityRequests) {
    return new ResponseEntity<>(hotelService.agregarAmenities(id, amenityRequests), HttpStatus.OK);
  }

  @Operation(
      summary = "Eliminar un amenity de un hotel",
  ...
  public ResponseEntity<Void> eliminarAmenity(
      @PathVariable Integer id, @PathVariable Long amenityId) {
    hotelService.eliminarAmenity(id, amenityId);
    return new ResponseEntity<>(HttpStatus.OK);
  }

  @Operation(
      summary = "Cerrar un hotel",
  ...
  @Operation(
      summary = "Consultar hoteles con filtros",
      description =
          "Permite consultar hoteles aplicando filtros opcionales como nombre, CUIT, domicilio, categoría y amenities.",
      responses = {
  ...
  public ResponseEntity<List<HotelResponse>> consultarHoteles(
    ...
    return new ResponseEntity<>(
        hotelService.consultarHoteles(nombre, cuit, domicilio, categoria, amenities),
        HttpStatus.OK);
  }
  ...
  @Operation(
      summary = "Listar amenities de un hotel",
